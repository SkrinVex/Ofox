                    ...
                    when (type) {
                        ...
                        "new_message" -> {
                            ...
                            _events.value = WSEvent.NewMessage(
                                ...
                                fileKey = json.optString("fileKey").takeIf { it.isNotBlank() && it != "null" },
                                fileName = json.optString("fileName").takeIf { it.isNotBlank() && it != "null" },
                                fileSize = json.optLong("fileSize", 0),
                                fileMime = json.optString("fileMime").takeIf { it.isNotBlank() && it != "null" }
                            )
                        }
                        "chat_update" -> {
                            val chatId = json.getInt("chatId")
...
sealed class WSEvent {
    ...
    data class NewMessage(val chatId: Int, val message: String, val timestamp: Long, val senderId: Int = 0, val senderName: String = "", val senderAvatarUrl: String? = null, val messageType: String = "text", val replyToId: Int? = null, val replyToText: String? = null, val replyToSenderName: String? = null, val imageKey: String? = null, val fileKey: String? = null, val fileName: String? = null, val fileSize: Long = 0, val fileMime: String? = null) : WSEvent()
    ...
    data class DiscoveryMessage(val chatId: Int, val message: String, val timestamp: Long, val senderId: Int = 0, val senderName: String = "", val senderAvatarUrl: String? = null, val messageType: String = "text", val replyToId: Int? = null, val replyToText: String? = null, val replyToSenderName: String? = null, val imageKey: String? = null, val fileKey: String? = null, val fileName: String? = null, val fileSize: Long = 0, val fileMime: String? = null) : WSEvent()
